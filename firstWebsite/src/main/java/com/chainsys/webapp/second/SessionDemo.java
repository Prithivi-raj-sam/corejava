...
//	else doGet(request,response);
	...
	currentSession.setMaxInactiveInterval(0); // no time out period if value is 0 or less than 0.it is infinite
	currentSession.setMaxInactiveInterval(5*60); // 5 minute timeout
